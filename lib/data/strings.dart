...
class Strings {
  ...
  static List<String> BURC_LOGO_RESIMLERI = resimListOlusturma();
  static List<String> BURC_LOGO_BUYUKRESIMLERI = sliverAppBarFlexibleSpace();

  // class içersinde method oluşturursan bu static olmalı!
  // static her yerde geçerli, ama static e sadece static dokunabilir!
  /*  static List<String> a() {
    List<String> kucukresimler = [];
    for (var i = 0; i < 12; i++) {
      kucukresimler.add('${Strings.BURC_ADLARI[i].toLowerCase()}${i + 1}.png');
    }
    print(kucukresimler);
    return kucukresimler;
  } */
}

List<String> resimListOlusturma() {
  List<String> kucukresimler = [];
  for (var i = 0; i < 12; i++) {
    kucukresimler.add('${Strings.BURC_ADLARI[i].toLowerCase()}${i + 1}.png');
  }
...
List<String> sliverAppBarFlexibleSpace() {
  List<String> buyukresimler = [];
  for (var i = 0; i < 12; i++) {
    buyukresimler
        .add('${Strings.BURC_ADLARI[i].toLowerCase()}_buyuk${i + 1}.png');
  }
  print(buyukresimler);
  return buyukresimler;
}
